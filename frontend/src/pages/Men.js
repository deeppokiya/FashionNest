...
const Men = () => {
  const [filters, setFilters] = useState({
    gender: 'M', // Always filter for men's products
    category: '',
    brand: '',
    search: '',
    ordering: '',
  ...
  const clearFilters = () => {
    setFilters({
      gender: 'M', // Keep gender filter for men
      category: '',
      brand: '',
      search: '',
      ordering: '',
  ...
  return (
    <div className="container">
      <div className="page-header men">
        <h1>Men's Fashion</h1>
        <p>Discover the latest trends in men's clothing, accessories, and more.</p>
      </div>
